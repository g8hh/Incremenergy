...
var cnItems = {
    ...
    'Start an Unfortunate run, which square roots all Energy exponents.': '开始一个不幸的运行，它对所有能量指数进行平方根。',
    'Mega Factories boost Split Atom & Gift gain.': '巨型工厂促进分裂原子和礼物增益。',
    'Hyper Luck': '究极幸运',
    'Hyper End': '究极终点',
    'Gift Power': '礼物力量',
    'Fortune Energy adds to the Hyper-Energy exponent & to Karma.': '财富能量增加了超能量指数和业力。',
    'Fortune Energy & Gifts make Skills stronger.': '财富能量和礼物使技能更强大。',
    'Excess Nuclearity': '过剩核率',
    'Each Mega Upgrade adds 0.05 to the Hyper-Energy exponent.': '每一次巨型升级都会增加0.05的究极能量指数。',
    'Neutral Karma': '中性业力',
    'Remove the softcaps of Self-Charging Batteries & Super Drives.': '移除自充电电池和超级驱动器的软上限。',
    'Split Atoms\' effect is 25% stronger, and they add to the Fortune Energy exponent at a reduced rate.': '分裂原子的效果增强 25%，并且它们以降低的速度增加财富能量指数。',
    'Split Atoms add to the Organic Teller, Mega Organic Teller, and Hyper Plant effects.': '分裂原子添加到有机柜员, 巨型有机柜员，和究极工厂效果。',
    'Skilled Ninja': '熟练的忍者',
    'Hyper Plants': '究极工厂',
    'Getting Gifts only decreases your Fortune Energy by 1, Gift gain is increased by 50%, and the Fortune Energy exponent is increased by 0.1.': '获得礼物只会减少你的财富能量1，礼物增益增加50%，财富能量指数增加0.1。',
    ...
    'Buy max Super-Energy Upgrades, and the first softcap of all Energy Upgrades (except Self-Charging Batteries) is 20% weaker.': '购买最大超级能量升级，所有能量升级的第一个软上限（自充电电池除外）弱 20%。',
    '': '',
    '': '',
    '': '',
    '': '',
